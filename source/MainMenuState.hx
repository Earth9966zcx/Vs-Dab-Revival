...
class MainMenuState extends MusicBeatState
{
    ...
    blackbars.loadGraphic("preload/images/menushits/titleoutline1.png");
    blackbars.y = -300;
    ...
    blackbars2.loadGraphic("preload/images/menushits/titleoutline2.png");
    blackbars2.y = 300;
    ...
    add(blackbars2);
		...
		for (i in 0...optionShit.length)
		{
		  ...
		  if (firstStart) {
		  	FlxTween.tween(blackbars2, {y: 0}, 0.3, {ease: FlxEase.expoInOut});
				FlxTween.tween(blackbars, {y: 0}, 0.3, {ease: FlxEase.expoInOut});
				}
